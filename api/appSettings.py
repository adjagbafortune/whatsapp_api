...
class AppSettings:
    def __init__(self) -> None:
        ...
        # Remplace les lignes actuelles par celles-ci :
        self.admin_ids = settings.admin_ids.split(",") if settings.admin_ids else []
        self.blacklist_ids = settings.blacklist_ids.split(",") if settings.blacklist_ids else []
        ...
        self.last_reminder_id = settings.last_reminder_id
        self.last_reminder_time = settings.last_reminder_time
...
try:
    ...
    print(f"DEBUG ERREUR : {e}") # <--- Ajoute cette ligne:
